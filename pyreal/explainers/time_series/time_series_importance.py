...
def tfi(return_contributions=True, return_explainer=False, explainer=None,
    ...
    Args:
        ...
        interpretable_features (Boolean):
            If True, return explanations using the interpretable feature descriptions
            instead of default names
...
class TimeSeriesImportance(ClassificationSaliencyBase):
    ...
    def get_contributions(self, x_orig):
        return self.base_time_contributions.get_contributions(x_orig)
