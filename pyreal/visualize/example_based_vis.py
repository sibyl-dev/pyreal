...
def example_table(
    explanation, input_row_name="Original Input", y_column_name="Ground Truth", y_format_func=None
):
    table = explanation["X"]
    explanation["Input"].name = input_row_name
    ...
    explanation["y"][input_row_name] = "N/A"
