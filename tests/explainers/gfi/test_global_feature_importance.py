...
def test_permutation_produce_classification_no_transforms(classification_no_transforms):
    ...
    helper_permutation_produce_classification_no_transforms(
        gfi, classification_no_transforms
    )
    helper_permutation_produce_classification_no_transforms(
...
def test_produce_permutation_regression_no_transforms_with_size(
...
def test_shap_produce_classification_no_transforms_with_size(
    ...
    helper_shap_produce_classification_no_transforms_with_size(
        gfi, classification_no_transforms
    )
    helper_shap_produce_classification_no_transforms_with_size(
        shap, classification_no_transforms
    )
...
def test_permutation_produce_classification_no_transforms_with_size(
    classification_no_transforms,
):
    model = classification_no_transforms
    gfi = GlobalFeatureImportance(
