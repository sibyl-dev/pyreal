...
>>> lfc = LocalFeatureContribution(model=model, x_train_orig=x_train_orig, m_transformers=transformers, e_transformers=transformers, feature_descriptions=feature_descriptions, fit_on_init=True)
>>> lfc.fit()
